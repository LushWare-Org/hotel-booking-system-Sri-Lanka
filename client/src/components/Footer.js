...
const Footer = () => {
  ...
  return (
    <AppBar position="static" style={{ backgroundColor: '#400D14', height: 'auto' }}>
      <Container>
        <Toolbar>
          <Grid container spacing={6} alignItems="center" marginTop="20px" gap={2}>
            ...
            <Grid item xs={12} sm={6} md={3} style={{ display: 'flex', justifyContent: 'center' }}>
              <Grid container direction="column" alignItems="center">
                <Button variant="text" component={Link} to="/" style={{ color: '#fff', marginTop: '0px', fontFamily:'Arial, sans-serif', fontSize:'15px'}} onClick={() => handleNavigation('Home')}>
                  Home
                </Button><br></br>
                <Button variant="text" component={Link} to="/rooms" style={{ color: '#fff', marginTop: '10px', fontFamily:'Arial, sans-serif', fontSize:'15px' }} onClick={() => handleNavigation('Rooms')}>
                  Rooms
                </Button><br></br>
                <Button variant="text" component={Link} to="/facilities" style={{ color: '#fff', marginTop: '10px', fontFamily:'Arial, sans-serif', fontSize:'15px' }} onClick={() => handleNavigation('Services')}>
                  Services
                </Button><br></br>
                <Button variant="text" component={Link} to="/contact" style={{ color: '#fff', marginTop: '10px', fontFamily:'Arial, sans-serif', fontSize:'15px' }} onClick={() => handleNavigation('Contact Us')}>
                  Contact Us
                </Button><br></br>
                <Button variant="text" component={Link} to="/login" style={{ color: '#fff', marginTop: '10px', fontFamily:'Arial, sans-serif', fontSize:'15px' }} onClick={() => handleNavigation('Contact Us')}>
                  Login
                </Button><br></br>
                <Button variant="text" component={Link} to="/register" style={{ color: '#fff', marginTop: '10px', fontFamily:'Arial, sans-serif', fontSize:'15px' }} onClick={() => handleNavigation('Contact Us')}>
                  Register
                </Button><br></br><br></br>
              </Grid>
            </Grid>
